...
namespace basicfinder\basicdataapi;

//use Yii;

class BasicdataApi
{
    private $apiHost = 'http://api.dataset.basicfinder.com';
    private $appKey = null;
    ...
    public function projects($page = 1, $count = 10, $keyword = '', $project_id = '', $fileType = '')
    {
        $_logs = ['$page' => $page, '$count' => $count, '$keyword' => $keyword, '$$project_id' => $project_id, '$$fileType' => $fileType];
        
        $url = $this->apiHost.'/dataset/projects';
        $data = [
            'page' => $page,
            'limit' => $count,
            'keyword' => $keyword,
